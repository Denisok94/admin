...
namespace denisok94\admin\components;
...
class Configs extends \denisok94\admin\BaseObject
{
    const CACHE_TAG = 'denisok94.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'denisok94.admin.configs', []);
