...
class Module extends \yii\base\Module
{
     ...
     */
    public $mainLayout = '@denisok94/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    {
        parent::init();
        // Yii::setAlias('@denisok94\admin',  __DIR__);

        if (!isset(Yii::$app->i18n->translations['rbac-admin'])) {
            Yii::$app->i18n->translations['rbac-admin'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'sourceLanguage' => 'ru-RU',
                'basePath' => '@denisok94/admin/messages',
            ];
        }
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('denisok94\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
    /**
     * Get available menu.
